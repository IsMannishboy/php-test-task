...
Route::get('/api/tickets/{ticket_id}/download', [TicketController::class, 'download'])->middleware(['auth','role:manager']);
Route::put('/api/tickets/{id}', [TicketController::class, 'update'])->middleware(['auth','role:manager']);
